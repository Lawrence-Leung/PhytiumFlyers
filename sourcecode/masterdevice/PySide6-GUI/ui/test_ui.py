...
"color: rgba(255, 255, 255, 255);")
        ...
        self.widget.setGeometry(QRect(10, 20, 50, 50))
        self.widget.setMaximumSize(QSize(50, 50))
        self.widget.setAutoFillBackground(False)
        self.widget.setStyleSheet(u"image:url(:/all/img/logo1.png);")
...
"}")
        ...
        self.label_2 = QLabel(self.MenuBox)
        self.label_2.setObjectName(u"label_2")

        self.verticalLayout_5.addWidget(self.label_2)

        self.log_list = QListWidget(self.MenuBox)
...
"")
        ...
        self.content = QTabWidget(self.ContentBox)
        self.content.setObjectName(u"content")
        self.contentPage1 = QWidget()
        self.contentPage1.setObjectName(u"contentPage1")
        self.horizontalLayout_5 = QHBoxLayout(self.contentPage1)
        ...
        self.char_label = QLabel(self.contentPage1)
        ...
        self.QF_Group = QFrame(self.contentPage1)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.gps_label = QLabel(self.Class_bottom)
        self.gps_label.setObjectName(u"gps_label")
        self.gps_label.setMinimumSize(QSize(0, 30))
        self.gps_label.setMaximumSize(QSize(16777215, 30))
        font3 = QFont()
        ...
        self.gps_label.setFont(font3)
        self.gps_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.gps_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_8.addWidget(self.gps_label, 0, Qt.AlignTop)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.stair_label = QLabel(self.Model_bottom)
        self.stair_label.setObjectName(u"stair_label")
        self.stair_label.setMinimumSize(QSize(0, 30))
        self.stair_label.setMaximumSize(QSize(16777215, 30))
        font4 = QFont()
        ...
        self.stair_label.setFont(font4)
        self.stair_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 15pt \"Microsoft YaHei UI\";\n"
"")
        self.stair_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_14.addWidget(self.stair_label, 0, Qt.AlignTop)
        ...
        self.Result_QF = QFrame(self.contentPage1)
...
"border-radius:15px")
        ...
        self.Pause_QF = QFrame(self.contentPage1)
...
"}")
        ...
        self.label_3 = QLabel(self.Pause_QF)
...
"}")
        ...
        self.prm_page = QFrame(self.contentPage1)
...
"        }")
        ...
        self.content.addTab(self.contentPage1, "")
        self.contentPage2 = QWidget()
        self.contentPage2.setObjectName(u"contentPage2")
        self.verticalLayoutWidget = QWidget(self.contentPage2)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(-1, -1, 1151, 641))
        self.main_content2 = QVBoxLayout(self.verticalLayoutWidget)
        self.main_content2.setObjectName(u"main_content2")
        self.main_content2.setContentsMargins(0, 0, 0, 0)
        self.char_label_2 = QLabel(self.verticalLayoutWidget)
        ...
        self.main_content2.addWidget(self.char_label_2)

        self.QF_Group_2 = QFrame(self.verticalLayoutWidget)
        self.QF_Group_2.setObjectName(u"QF_Group_2")
        self.QF_Group_2.setMinimumSize(QSize(0, 100))
        self.QF_Group_2.setMaximumSize(QSize(16777215, 100))
...
"}")
        ...
        self.horizontalLayout_20 = QHBoxLayout(self.QF_Group_2)
        self.horizontalLayout_20.setObjectName(u"horizontalLayout_20")
        self.horizontalLayout_20.setContentsMargins(-1, 9, -1, 15)
        self.Class_QF_3 = QFrame(self.QF_Group_2)
        self.Class_QF_3.setObjectName(u"Class_QF_3")
        self.Class_QF_3.setMinimumSize(QSize(170, 80))
        self.Class_QF_3.setMaximumSize(QSize(170, 80))
        self.Class_QF_3.setToolTipDuration(0)
        self.Class_QF_3.setStyleSheet(u"QFrame#Class_QF_3{\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color:rgb(136, 138, 133);\n"
"border: 1px outset rgb(98, 91, 213);\n"
"}\n"
"")
        self.Class_QF_3.setFrameShape(QFrame.StyledPanel)
        self.Class_QF_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_31 = QVBoxLayout(self.Class_QF_3)
        self.verticalLayout_31.setSpacing(0)
        self.verticalLayout_31.setObjectName(u"verticalLayout_31")
        self.verticalLayout_31.setContentsMargins(0, 0, 0, 0)
        self.Class_top_3 = QFrame(self.Class_QF_3)
        self.Class_top_3.setObjectName(u"Class_top_3")
        self.Class_top_3.setStyleSheet(u"border:none")
        self.Class_top_3.setFrameShape(QFrame.StyledPanel)
        self.Class_top_3.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_21 = QHBoxLayout(self.Class_top_3)
        self.horizontalLayout_21.setSpacing(0)
        self.horizontalLayout_21.setObjectName(u"horizontalLayout_21")
        self.horizontalLayout_21.setContentsMargins(0, 3, 0, 3)
        self.label_13 = QLabel(self.Class_top_3)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_31.addWidget(self.Class_top_3)

        self.line_10 = QFrame(self.Class_QF_3)
        self.line_10.setObjectName(u"line_10")
        self.line_10.setMaximumSize(QSize(16777215, 1))
        self.line_10.setStyleSheet(u"background-color: rgba(255, 255, 255, 89);")
        self.line_10.setFrameShape(QFrame.HLine)
        self.line_10.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_31.addWidget(self.line_10)

        self.Class_bottom_3 = QFrame(self.Class_QF_3)
        self.Class_bottom_3.setObjectName(u"Class_bottom_3")
        self.Class_bottom_3.setStyleSheet(u"border:none")
        self.Class_bottom_3.setFrameShape(QFrame.StyledPanel)
        self.Class_bottom_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_32 = QVBoxLayout(self.Class_bottom_3)
        self.verticalLayout_32.setSpacing(0)
        self.verticalLayout_32.setObjectName(u"verticalLayout_32")
        self.verticalLayout_32.setContentsMargins(0, 6, 0, 6)
        self.Class_num_3 = QLabel(self.Class_bottom_3)
        self.Class_num_3.setObjectName(u"Class_num_3")
        self.Class_num_3.setMinimumSize(QSize(0, 30))
        self.Class_num_3.setMaximumSize(QSize(16777215, 30))
        self.Class_num_3.setFont(font3)
        self.Class_num_3.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.Class_num_3.setAlignment(Qt.AlignCenter)

        self.verticalLayout_32.addWidget(self.Class_num_3, 0, Qt.AlignTop)


        self.verticalLayout_31.addWidget(self.Class_bottom_3)

        self.verticalLayout_31.setStretch(1, 2)
        self.verticalLayout_31.setStretch(2, 1)

        self.horizontalLayout_20.addWidget(self.Class_QF_3)

        self.Target_QF_3 = QFrame(self.QF_Group_2)
        self.Target_QF_3.setObjectName(u"Target_QF_3")
        self.Target_QF_3.setMinimumSize(QSize(170, 80))
        self.Target_QF_3.setMaximumSize(QSize(170, 80))
        self.Target_QF_3.setToolTipDuration(0)
        self.Target_QF_3.setStyleSheet(u"QFrame#Target_QF_3{\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: rgb(186, 189, 182);\n"
"border: 1px outset rgb(252, 194, 149)\n"
"}\n"
"")
        self.Target_QF_3.setFrameShape(QFrame.StyledPanel)
        self.Target_QF_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_33 = QVBoxLayout(self.Target_QF_3)
        self.verticalLayout_33.setSpacing(0)
        self.verticalLayout_33.setObjectName(u"verticalLayout_33")
        self.verticalLayout_33.setContentsMargins(0, 0, 0, 0)
        self.Target_top_3 = QFrame(self.Target_QF_3)
        self.Target_top_3.setObjectName(u"Target_top_3")
        self.Target_top_3.setStyleSheet(u"border:none")
        self.Target_top_3.setFrameShape(QFrame.StyledPanel)
        self.Target_top_3.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_22 = QHBoxLayout(self.Target_top_3)
        self.horizontalLayout_22.setSpacing(0)
        self.horizontalLayout_22.setObjectName(u"horizontalLayout_22")
        self.horizontalLayout_22.setContentsMargins(0, 3, 0, 3)
        self.label_14 = QLabel(self.Target_top_3)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_33.addWidget(self.Target_top_3)

        self.line_11 = QFrame(self.Target_QF_3)
        self.line_11.setObjectName(u"line_11")
        self.line_11.setMaximumSize(QSize(16777215, 1))
        self.line_11.setStyleSheet(u"background-color: rgba(255, 255, 255, 89);")
        self.line_11.setFrameShape(QFrame.HLine)
        self.line_11.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_33.addWidget(self.line_11)

        self.Target_bottom_3 = QFrame(self.Target_QF_3)
        self.Target_bottom_3.setObjectName(u"Target_bottom_3")
        self.Target_bottom_3.setStyleSheet(u"border:none")
        self.Target_bottom_3.setFrameShape(QFrame.StyledPanel)
        self.Target_bottom_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_34 = QVBoxLayout(self.Target_bottom_3)
        self.verticalLayout_34.setSpacing(0)
        self.verticalLayout_34.setObjectName(u"verticalLayout_34")
        self.verticalLayout_34.setContentsMargins(0, 6, 0, 6)
        self.Target_num_3 = QLabel(self.Target_bottom_3)
        self.Target_num_3.setObjectName(u"Target_num_3")
        self.Target_num_3.setMinimumSize(QSize(0, 30))
        self.Target_num_3.setMaximumSize(QSize(16777215, 30))
        self.Target_num_3.setFont(font3)
        self.Target_num_3.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.Target_num_3.setAlignment(Qt.AlignCenter)

        self.verticalLayout_34.addWidget(self.Target_num_3, 0, Qt.AlignTop)


        self.verticalLayout_33.addWidget(self.Target_bottom_3)

        self.verticalLayout_33.setStretch(1, 2)
        self.verticalLayout_33.setStretch(2, 1)

        self.horizontalLayout_20.addWidget(self.Target_QF_3)

        self.Fps_QF_3 = QFrame(self.QF_Group_2)
        self.Fps_QF_3.setObjectName(u"Fps_QF_3")
        self.Fps_QF_3.setMinimumSize(QSize(170, 80))
        self.Fps_QF_3.setMaximumSize(QSize(170, 80))
        self.Fps_QF_3.setToolTipDuration(0)
        self.Fps_QF_3.setStyleSheet(u"QFrame#Fps_QF_3{\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: rgb(211, 215, 207);\n"
"border: 1px outset rgb(153, 117, 219)\n"
"}\n"
"")
        self.Fps_QF_3.setFrameShape(QFrame.StyledPanel)
        self.Fps_QF_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_35 = QVBoxLayout(self.Fps_QF_3)
        self.verticalLayout_35.setSpacing(0)
        self.verticalLayout_35.setObjectName(u"verticalLayout_35")
        self.verticalLayout_35.setContentsMargins(0, 0, 0, 0)
        self.Fps_top_3 = QFrame(self.Fps_QF_3)
        self.Fps_top_3.setObjectName(u"Fps_top_3")
        self.Fps_top_3.setStyleSheet(u"border:none")
        self.Fps_top_3.setFrameShape(QFrame.StyledPanel)
        self.Fps_top_3.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_23 = QHBoxLayout(self.Fps_top_3)
        self.horizontalLayout_23.setSpacing(0)
        self.horizontalLayout_23.setObjectName(u"horizontalLayout_23")
        self.horizontalLayout_23.setContentsMargins(0, 3, 7, 3)
        self.label_15 = QLabel(self.Fps_top_3)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_35.addWidget(self.Fps_top_3)

        self.line_12 = QFrame(self.Fps_QF_3)
        self.line_12.setObjectName(u"line_12")
        self.line_12.setMaximumSize(QSize(16777215, 1))
        self.line_12.setStyleSheet(u"background-color: rgba(255, 255, 255, 89);")
        self.line_12.setFrameShape(QFrame.HLine)
        self.line_12.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_35.addWidget(self.line_12)

        self.Fps_bottom_3 = QFrame(self.Fps_QF_3)
        self.Fps_bottom_3.setObjectName(u"Fps_bottom_3")
        self.Fps_bottom_3.setStyleSheet(u"border:none")
        self.Fps_bottom_3.setFrameShape(QFrame.StyledPanel)
        self.Fps_bottom_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_36 = QVBoxLayout(self.Fps_bottom_3)
        self.verticalLayout_36.setSpacing(0)
        self.verticalLayout_36.setObjectName(u"verticalLayout_36")
        self.verticalLayout_36.setContentsMargins(0, 6, 0, 6)
        self.fps_label_3 = QLabel(self.Fps_bottom_3)
        self.fps_label_3.setObjectName(u"fps_label_3")
        self.fps_label_3.setMinimumSize(QSize(0, 30))
        self.fps_label_3.setMaximumSize(QSize(16777215, 30))
        self.fps_label_3.setFont(font3)
        self.fps_label_3.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.fps_label_3.setAlignment(Qt.AlignCenter)

        self.verticalLayout_36.addWidget(self.fps_label_3, 0, Qt.AlignTop)


        self.verticalLayout_35.addWidget(self.Fps_bottom_3)

        self.verticalLayout_35.setStretch(1, 2)
        self.verticalLayout_35.setStretch(2, 1)

        self.horizontalLayout_20.addWidget(self.Fps_QF_3)

        self.Model_QF_4 = QFrame(self.QF_Group_2)
        self.Model_QF_4.setObjectName(u"Model_QF_4")
        self.Model_QF_4.setMinimumSize(QSize(170, 80))
        self.Model_QF_4.setMaximumSize(QSize(170, 80))
        self.Model_QF_4.setToolTipDuration(0)
        self.Model_QF_4.setStyleSheet(u"QFrame#Model_QF_4{\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: rgb(136, 138, 133);\n"
"border: 1px outset rgb(72, 158, 204)\n"
"}\n"
"")
        self.Model_QF_4.setFrameShape(QFrame.StyledPanel)
        self.Model_QF_4.setFrameShadow(QFrame.Raised)
        self.verticalLayout_37 = QVBoxLayout(self.Model_QF_4)
        self.verticalLayout_37.setSpacing(0)
        self.verticalLayout_37.setObjectName(u"verticalLayout_37")
        self.verticalLayout_37.setContentsMargins(0, 0, 0, 0)
        self.Model_top_3 = QFrame(self.Model_QF_4)
        self.Model_top_3.setObjectName(u"Model_top_3")
        self.Model_top_3.setStyleSheet(u"border:none")
        self.Model_top_3.setFrameShape(QFrame.StyledPanel)
        self.Model_top_3.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_24 = QHBoxLayout(self.Model_top_3)
        self.horizontalLayout_24.setSpacing(0)
        self.horizontalLayout_24.setObjectName(u"horizontalLayout_24")
        self.horizontalLayout_24.setContentsMargins(0, 3, 7, 3)
        self.label_16 = QLabel(self.Model_top_3)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_37.addWidget(self.Model_top_3)

        self.line_13 = QFrame(self.Model_QF_4)
        self.line_13.setObjectName(u"line_13")
        self.line_13.setMaximumSize(QSize(16777215, 1))
        self.line_13.setStyleSheet(u"background-color: rgba(255, 255, 255, 89);")
        self.line_13.setFrameShape(QFrame.HLine)
        self.line_13.setFrameShadow(QFrame.Sunken)

        self.verticalLayout_37.addWidget(self.line_13)

        self.Model_bottom_3 = QFrame(self.Model_QF_4)
        self.Model_bottom_3.setObjectName(u"Model_bottom_3")
        self.Model_bottom_3.setStyleSheet(u"border:none")
        self.Model_bottom_3.setFrameShape(QFrame.StyledPanel)
        self.Model_bottom_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_38 = QVBoxLayout(self.Model_bottom_3)
        self.verticalLayout_38.setSpacing(0)
        self.verticalLayout_38.setObjectName(u"verticalLayout_38")
        self.verticalLayout_38.setContentsMargins(0, 6, 0, 6)
        self.stair_label_3 = QLabel(self.Model_bottom_3)
        self.stair_label_3.setObjectName(u"stair_label_3")
        self.stair_label_3.setMinimumSize(QSize(0, 30))
        self.stair_label_3.setMaximumSize(QSize(16777215, 30))
        self.stair_label_3.setFont(font4)
        self.stair_label_3.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 15pt \"Microsoft YaHei UI\";\n"
"")
        self.stair_label_3.setAlignment(Qt.AlignCenter)

        self.verticalLayout_38.addWidget(self.stair_label_3, 0, Qt.AlignTop)


        self.verticalLayout_37.addWidget(self.Model_bottom_3)

        self.verticalLayout_37.setStretch(1, 2)
        self.verticalLayout_37.setStretch(2, 1)

        self.horizontalLayout_20.addWidget(self.Model_QF_4)


        self.main_content2.addWidget(self.QF_Group_2)

        self.Result_QF_2 = QFrame(self.verticalLayoutWidget)
        ...
        self.pre_video_3 = QLabel(self.splitter_2)
        self.pre_video_3.setObjectName(u"pre_video_3")
        self.pre_video_3.setMinimumSize(QSize(200, 100))
        self.pre_video_3.setStyleSheet(u"background-color: rgb(238, 242, 255);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.pre_video_3.setAlignment(Qt.AlignCenter)
        self.splitter_2.addWidget(self.pre_video_3)
        self.res_video_3 = QLabel(self.splitter_2)
        self.res_video_3.setObjectName(u"res_video_3")
        self.res_video_3.setMinimumSize(QSize(200, 100))
        self.res_video_3.setStyleSheet(u"background-color: rgb(238, 242, 255);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        self.res_video_3.setAlignment(Qt.AlignCenter)
        self.splitter_2.addWidget(self.res_video_3)

        self.verticalLayout_39.addWidget(self.splitter_2)


        self.main_content2.addWidget(self.Result_QF_2)

        self.content.addTab(self.contentPage2, "")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Author.setText("")
        self.Title.setText(QCoreApplication.translate("MainWindow", u"SystemGUI", None))
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; font-style:italic; color:#eeeeec;\">System Log</span></p></body></html>", None))
        ...
        ___qlistwidgetitem.setText(QCoreApplication.translate("MainWindow", u"system log:", None));
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"Blind Helping System GUI", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"Detection", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>GPS</p></body></html>", None))
        self.gps_label.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>FPS1</p></body></html>", None))
        self.Target_num.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Fps", None))
        self.fps_label.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Stair Num</p></body></html>", None))
        self.stair_label.setText("")
        self.pre_video.setText("")
        self.res_video.setText("")
        self.run_button.setText("")
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u4f4d\u7f6e\uff1a</p></body></html>", None))
        ...
        self.content.setTabText(self.content.indexOf(self.contentPage1), "")
        self.char_label_2.setText(QCoreApplication.translate("MainWindow", u"Detection", None))
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>GPS</p></body></html>", None))
        self.Class_num_3.setText("")
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>FPS1</p></body></html>", None))
        self.Target_num_3.setText("")
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Fps", None))
        self.fps_label_3.setText("")
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Stair Num</p></body></html>", None))
        self.stair_label_3.setText("")
        self.pre_video_3.setText("")
        self.res_video_3.setText("")
        self.content.setTabText(self.content.indexOf(self.contentPage2), QCoreApplication.translate("MainWindow", u"Page", None))
