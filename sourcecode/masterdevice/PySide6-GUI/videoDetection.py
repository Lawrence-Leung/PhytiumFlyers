...
class VideoDetection(QObject):
    ...
    def __init__(self, lanemodel_path, detectmodel_path):
        super().__init__()
        lanemodel_path = "/home/user/Desktop/masterdevice/PhytiumMasterProject202403/models/lane_int8.onnx"
        detectmodel_path = "/home/user/Desktop/masterdevice/PhytiumMasterProject202403/models/yolov5n_lite.onnx"
    ...
    def initialize_video(self, video_path):
        ...
        self.staircap=cv2.VideoCapture("/home/user/Videos/stair2.mp4")
        return self.cap
    ...
    def start_detection(self):
        ...
        self.timer.start(30)  # 设置每 30 毫秒处理一帧
