...
# OpenImagesv7数据集的800个label classes，在此列出来
ClassesOpenImagesv7 = ['Accordion', 'Adhesive tape', 'Aircraft', 'Airplane', 'Alarm clock', 'Alpaca', 'Ambulance', 'Animal', 'Ant',
...
# COCO80数据集的80个label classes
ClassesCOCO80 = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
...
class YOLOV5V8():
    ...
    def __init__(self, onnxpath: object, isType='YOLOV8') -> object:
        ...
        if isType == 'COCO80':
            self.CLASSES = ClassesCOCO80  # 使用YOLOv5的COCO80数据集
        elif isType == 'OpenImagesv7':
            self.CLASSES = ClassesOpenImagesv7  # 使用YOLOv8的OpenImagesv7数据集
        else:
    ...
    def drawWithMapOutput(self, image: object, box_data: object) -> object:
        ...
        return output_target_list[:78]  # 取前78个