...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Main_QF.setAutoFillBackground(False)
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.Target_QF.setMinimumSize(QSize(200, 80))
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.status_label = QLabel(self.Target_bottom)
...
"font: 17pt \"Microsoft YaHei UI\";")
        ...
        self.verticalLayout_10.addWidget(self.status_label, 0, Qt.AlignTop)
        ...
        self.Fps_QF.setMinimumSize(QSize(200, 80))
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.cam_label = QLabel(self.Fps_bottom)
        self.cam_label.setObjectName(u"cam_label")
        self.cam_label.setMinimumSize(QSize(0, 30))
        self.cam_label.setMaximumSize(QSize(16777215, 30))
        self.cam_label.setFont(font3)
        self.cam_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.cam_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_12.addWidget(self.cam_label, 0, Qt.AlignTop)
        ...
        self.Model_QF.setMinimumSize(QSize(200, 80))
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.hum_label = QLabel(self.Model_bottom)
        self.hum_label.setObjectName(u"hum_label")
        self.hum_label.setMinimumSize(QSize(0, 30))
        self.hum_label.setMaximumSize(QSize(16777215, 30))
        font4 = QFont()
        ...
        self.hum_label.setFont(font4)
        self.hum_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 15pt \"Microsoft YaHei UI\";\n"
"")
        self.hum_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_14.addWidget(self.hum_label, 0, Qt.AlignTop)
...
"        }")
        ...
        self.tab.setMaximumSize(QSize(1148, 634))
        self.layoutWidget = QWidget(self.tab)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(0, 0, 1151, 631))
        self.main_content_2 = QVBoxLayout(self.layoutWidget)
        self.main_content_2.setSpacing(5)
        self.main_content_2.setObjectName(u"main_content_2")
        self.main_content_2.setContentsMargins(0, 0, 0, 0)
        self.char_label_2 = QLabel(self.layoutWidget)
        ...
        self.main_content_2.addWidget(self.char_label_2)

        self.QF_Group_2 = QFrame(self.layoutWidget)
...
"}")
        ...
        self.horizontalLayout_14 = QHBoxLayout(self.QF_Group_2)
        ...
        self.Class_QF_2.setMinimumSize(QSize(250, 80))
...
"")
        ...
        self.verticalLayout_17 = QVBoxLayout(self.Class_QF_2)
        ...
        self.horizontalLayout_15 = QHBoxLayout(self.Class_top_2)
        self.horizontalLayout_15.setSpacing(0)
        self.horizontalLayout_15.setObjectName(u"horizontalLayout_15")
        self.horizontalLayout_15.setContentsMargins(0, 3, 0, 3)
        self.label_9 = QLabel(self.Class_top_2)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_17.addWidget(self.Class_top_2)
        ...
        self.cpu_label1 = QFrame(self.Class_QF_2)
        self.cpu_label1.setObjectName(u"cpu_label1")
        self.cpu_label1.setStyleSheet(u"border:none")
        self.cpu_label1.setFrameShape(QFrame.StyledPanel)
        self.cpu_label1.setFrameShadow(QFrame.Raised)
        self.verticalLayout_23 = QVBoxLayout(self.cpu_label1)
        self.verticalLayout_23.setSpacing(0)
        self.verticalLayout_23.setObjectName(u"verticalLayout_23")
        self.verticalLayout_23.setContentsMargins(0, 6, 0, 6)
        self.cpu_label = QLabel(self.cpu_label1)
        self.cpu_label.setObjectName(u"cpu_label")
        self.cpu_label.setMinimumSize(QSize(0, 30))
        self.cpu_label.setMaximumSize(QSize(16777215, 30))
        self.cpu_label.setFont(font3)
        self.cpu_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.cpu_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_23.addWidget(self.cpu_label, 0, Qt.AlignTop)


        self.verticalLayout_17.addWidget(self.cpu_label1)

        self.verticalLayout_17.setStretch(1, 2)
        self.verticalLayout_17.setStretch(2, 1)

        self.horizontalLayout_14.addWidget(self.Class_QF_2)

        self.Fps_QF_2 = QFrame(self.QF_Group_2)
        self.Fps_QF_2.setObjectName(u"Fps_QF_2")
        self.Fps_QF_2.setMinimumSize(QSize(200, 80))
...
"")
        ...
        self.verticalLayout_26 = QVBoxLayout(self.Fps_QF_2)
        ...
        self.horizontalLayout_17 = QHBoxLayout(self.Fps_top_2)
        self.horizontalLayout_17.setSpacing(0)
        self.horizontalLayout_17.setObjectName(u"horizontalLayout_17")
        self.horizontalLayout_17.setContentsMargins(0, 3, 7, 3)
        self.label_11 = QLabel(self.Fps_top_2)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_26.addWidget(self.Fps_top_2)

        self.line_8 = QFrame(self.Fps_QF_2)
        ...
        self.verticalLayout_27 = QVBoxLayout(self.Fps_bottom_2)
        self.verticalLayout_27.setSpacing(0)
        self.verticalLayout_27.setObjectName(u"verticalLayout_27")
        self.verticalLayout_27.setContentsMargins(0, 6, 0, 6)
        self.time0_label = QLabel(self.Fps_bottom_2)
        self.time0_label.setObjectName(u"time0_label")
        self.time0_label.setMinimumSize(QSize(0, 30))
        self.time0_label.setMaximumSize(QSize(16777215, 30))
        self.time0_label.setFont(font3)
        self.time0_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 17pt \"Microsoft YaHei UI\";")
        self.time0_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_27.addWidget(self.time0_label, 0, Qt.AlignTop)


        self.verticalLayout_26.addWidget(self.Fps_bottom_2)

        self.verticalLayout_26.setStretch(1, 2)
        self.verticalLayout_26.setStretch(2, 1)

        self.horizontalLayout_14.addWidget(self.Fps_QF_2)

        self.Model_QF_3 = QFrame(self.QF_Group_2)
        self.Model_QF_3.setObjectName(u"Model_QF_3")
        self.Model_QF_3.setMinimumSize(QSize(200, 80))
        self.Model_QF_3.setMaximumSize(QSize(170, 80))
        self.Model_QF_3.setToolTipDuration(0)
        self.Model_QF_3.setStyleSheet(u"QFrame#Model_QF_3{\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 15px;\n"
"background-color: rgb(136, 138, 133);\n"
"border: 1px outset rgb(72, 158, 204)\n"
"}\n"
"")
        self.Model_QF_3.setFrameShape(QFrame.StyledPanel)
        self.Model_QF_3.setFrameShadow(QFrame.Raised)
        self.verticalLayout_28 = QVBoxLayout(self.Model_QF_3)
        self.verticalLayout_28.setSpacing(0)
        self.verticalLayout_28.setObjectName(u"verticalLayout_28")
        self.verticalLayout_28.setContentsMargins(0, 0, 0, 0)
        self.Model_top_2 = QFrame(self.Model_QF_3)
        self.Model_top_2.setObjectName(u"Model_top_2")
        self.Model_top_2.setStyleSheet(u"border:none")
        self.Model_top_2.setFrameShape(QFrame.StyledPanel)
        self.Model_top_2.setFrameShadow(QFrame.Raised)
        self.horizontalLayout_18 = QHBoxLayout(self.Model_top_2)
        self.horizontalLayout_18.setSpacing(0)
        self.horizontalLayout_18.setObjectName(u"horizontalLayout_18")
        self.horizontalLayout_18.setContentsMargins(0, 3, 7, 3)
        self.label_12 = QLabel(self.Model_top_2)
...
"font: 700 italic 16pt \"Segoe UI\";")
        ...
        self.verticalLayout_28.addWidget(self.Model_top_2)

        self.line_9 = QFrame(self.Model_QF_3)
        ...
        self.Model_bottom_2 = QFrame(self.Model_QF_3)
        self.Model_bottom_2.setObjectName(u"Model_bottom_2")
        self.Model_bottom_2.setStyleSheet(u"border:none")
        self.Model_bottom_2.setFrameShape(QFrame.StyledPanel)
        self.Model_bottom_2.setFrameShadow(QFrame.Raised)
        self.verticalLayout_29 = QVBoxLayout(self.Model_bottom_2)
        self.verticalLayout_29.setSpacing(0)
        self.verticalLayout_29.setObjectName(u"verticalLayout_29")
        self.verticalLayout_29.setContentsMargins(0, 6, 0, 6)
        self.time1_label = QLabel(self.Model_bottom_2)
        self.time1_label.setObjectName(u"time1_label")
        self.time1_label.setMinimumSize(QSize(0, 30))
        self.time1_label.setMaximumSize(QSize(16777215, 30))
        self.time1_label.setFont(font4)
        self.time1_label.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"font: 15pt \"Microsoft YaHei UI\";\n"
"")
        self.time1_label.setAlignment(Qt.AlignCenter)

        self.verticalLayout_29.addWidget(self.time1_label, 0, Qt.AlignTop)


        self.verticalLayout_28.addWidget(self.Model_bottom_2)

        self.verticalLayout_28.setStretch(1, 2)
        self.verticalLayout_28.setStretch(2, 1)

        self.horizontalLayout_14.addWidget(self.Model_QF_3)


        self.main_content_2.addWidget(self.QF_Group_2)

        self.Result_QF_2 = QFrame(self.layoutWidget)
        ...
        self.verticalLayout_30 = QVBoxLayout(self.Result_QF_2)
...
"border-radius:15px")
        ...
        self.res_video_2.setStyleSheet(u"background-color: rgb(238, 242, 255);\n"
"border:2px solid rgb(255, 255, 255);\n"
"border-radius:15px")
        ...
        self.Pause_QF_2 = QFrame(self.layoutWidget)
        ...
        self.horizontalLayout_19 = QHBoxLayout(self.Pause_QF_2)
        self.horizontalLayout_19.setSpacing(10)
        self.horizontalLayout_19.setObjectName(u"horizontalLayout_19")
        self.horizontalLayout_19.setContentsMargins(0, 0, 3, 0)
        self.cputotal_label = QLabel(self.Pause_QF_2)
        self.cputotal_label.setObjectName(u"cputotal_label")
        sizePolicy2.setHeightForWidth(self.cputotal_label.sizePolicy().hasHeightForWidth())
        self.cputotal_label.setSizePolicy(sizePolicy2)
        self.cputotal_label.setMinimumSize(QSize(5, 0))
        self.cputotal_label.setMaximumSize(QSize(16777215, 16777215))
        self.cputotal_label.setStyleSheet(u"font: 700 11pt \"Segoe UI\";\n"
"color: rgba(0, 0, 0, 140);")

        self.horizontalLayout_19.addWidget(self.cputotal_label)


        self.main_content_2.addWidget(self.Pause_QF_2)

        self.content.addTab(self.tab, "")
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><br/></p></body></html>", None))
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Walking Status</p><p><br/></p></body></html>", None))
        self.status_label.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Cam Status</p></body></html>", None))
        self.cam_label.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\uff08Humi,Temp)</p></body></html>", None))
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>CPU1, CPU2, CPU3</p></body></html>", None))
        self.cpu_label.setText("")
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Response Time</p></body></html>", None))
        self.time0_label.setText("")
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Master to Slave</p></body></html>", None))
        self.time1_label.setText("")
        self.pre_video_2.setText("")
        self.res_video_2.setText("")
        self.cputotal_label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><br/></p></body></html>", None))
        self.content.setTabText(self.content.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Page", None))
