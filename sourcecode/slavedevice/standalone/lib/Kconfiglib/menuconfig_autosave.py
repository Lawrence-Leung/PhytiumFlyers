...
def menuconfig(kconf):
    ...
    # Enter curses mode. _update_menuconfig() returns a string to print on exit, after
    # curses has been de-initialized.
    print(curses.wrapper(_update_menuconfig))
...
def _update_menuconfig(stdscr):
    ...
    _try_save(_kconf.write_config, _conf_filename, "configuration")
    return 
