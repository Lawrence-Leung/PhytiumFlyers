...
/**
 * @brief Get information about the card to a structure
 * @param card  card information structure initialized using sdmmc_card_init
 */
 ...
 *              using sdmmc_card_init
 * @return
 *      - SDMMC_OK if supported by the card/device
 *      - SDMMC_FAIL if not supported by the card/device
 */
 ...
 */
sdmmc_err_t sdmmc_io_wait_int(sdmmc_card_t* card, tick_type_t timeout_ticks);
