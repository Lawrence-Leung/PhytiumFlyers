...
#define SD_R1_CURRENT_STATE(x)          (((x) & MMC_R1_CURRENT_STATE_MASK) >> MMC_R1_CURRENT_STATE_POS) /* sx, b (4 bits) */
...
/* EXT_CSD_CARD_TYPE, according to eMMC spec. Table 137 — Device types */
