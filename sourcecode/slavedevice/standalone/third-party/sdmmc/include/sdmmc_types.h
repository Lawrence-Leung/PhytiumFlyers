...
#define SDMMC_FREQ_DEFAULT      25000       /*!< SD/MMC Default speed, according to SD 2.0 spec. Default mode, 0~25MHz  */
#define SDMMC_FREQ_HIGHSPEED    50000       /*!< SD High speed, according to SD 2.0 spec. High speed mode, 0~50MHz  */
#define SDMMC_FREQ_PROBING      400         /*!< SD/MMC probing speed */
#define SDMMC_FREQ_50M          50000       /*!< MMC 50MHz speed in kHz */    
#define SDMMC_FREQ_52M          52000       /*!< MMC 52MHz speed in kHz */
#define SDMMC_FREQ_26M          26000       /*!< MMC 26MHz speed in kHz */
    int type;   /*!< type info of host */    
    ...
    sdmmc_err_t (*io_int_wait)(int slot, tick_type_t timeout_ticks); /*!< Host function to wait for SDIO interrupt line to be active */
    int command_timeout_ms;     /*!< timeout, in milliseconds, of a single command. Set to 0 to use the default value. */
    sdmmc_err_t (*get_real_freq)(int slot, int* real_freq); /*!< Host function to provide real working freq, based on SDMMC controller setup */
} sdmmc_host_t;
...
/**
 * SD/MMC card information structure for lookup
 */
typedef struct
{
